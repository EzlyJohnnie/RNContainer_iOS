...
@implementation UIColor (RNConainter)
+ (UIColor *)appMainColor{
    return [UIColor colorWithRed:21.0/255.0 green:46.0/255.0 blue:86.0/255.0 alpha:1];
}
...
+ (UIColor *)cancelRed{
    return [UIColor colorWithRed:221.0/255.0 green:81.0/255.0 blue:70.0/255.0 alpha:1];
}
...
+ (UIColor *)borderSelectedColor{
    return [UIColor colorWithRed:79.0/255.0 green:64.0/255.0 blue:62.0/255.0 alpha:1.0];
}

+ (UIColor *)borderErrorColor{
    return [UIColor colorWithRed:239.0/255.0 green:90.0/255.0 blue:102.0/255.0 alpha:1.0];
}
